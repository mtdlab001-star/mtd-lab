...
export async function POST(req:Request){
  ...
  try{
    ...
    const preflightRes=await fetch(`${hmrcApiBase}/agents/${encodeURIComponent(arn)}/invitations`,{method:'GET',headers:{Authorization:`Bearer ${accessToken}`,Accept:ACCEPT_V2},cache:'no-store'})
