...
async function handle(req:Request,source:URLSearchParams|FormData){
 ...
 if(is2026On&&!v3Enabled){back.searchParams.set('error','HMRC has not yet published Individuals Other Income API v3 for 2026-27 in the Developer Hub. Retrieval is temporarily unavailable for this tax year.');return NextResponse.redirect(back,303)}
