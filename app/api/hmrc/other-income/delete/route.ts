...
export async function POST(req:Request){
 ...
 if(is2026On&&!v3Enabled){back.searchParams.set('error','HMRC has not yet published Individuals Other Income API v3 for 2026-27 in the Developer Hub. Delete is temporarily unavailable for this tax year.');return NextResponse.redirect(back,303)}
