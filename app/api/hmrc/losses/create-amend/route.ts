...
export async function POST(req:Request){
 ...
 if(!taxYearHasEnded(taxYear)){back.searchParams.set('error','HMRC loss claims can only be created or amended after the tax year has ended');return NextResponse.redirect(back,303)}
