...
export default async function SandboxTaxpayerPage(){
  let metrics={workspaces:0,connections:0,syncs:0,agents:0,agentAuthorisations:0,quarterly:0,quarterlyDirect:0,quarterlyAgent:0,calculations:0,finalDeclarations:0,finalDirect:0,finalAgent:0}
  try{
    ...
    metrics={workspaces:t.count||0,connections:c.count||0,syncs:s.count||0,agents:a.count||0,agentAuthorisations:aa.count||0,quarterly:q.count||0,quarterlyDirect:qd.count||0,quarterlyAgent:qa.count||0,calculations:calc.count||0,finalDeclarations:finals.count||0,finalDirect:fd.count||0,finalAgent:fa.count||0}
  }catch{}
  return <div className="shell"><aside className="side"><div className="brand">MTD Lab</div><div className="nav"><Link href="/">Dashboard</Link><Link href="/taxpayers">Taxpayers</Link><Link href="/agents">Agents</Link><span>Sandbox setup</span></div><div className="operator">Operated by Glomaxel IT Service</div></aside><main className="main">
