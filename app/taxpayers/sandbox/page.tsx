...
export default function SandboxTaxpayerPage(){
  return <div className="shell">
    ...
    <main className="main">
      ...
      <div className="status">After the workspace is created, use Connect to HMRC and sign in with the same HMRC sandbox test user credentials that generated these tax identifiers. Production submissions remain separately controlled and must not be enabled by sandbox validation.</div>
    </main>
  </div>
}
